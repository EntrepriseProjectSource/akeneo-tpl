...
class FamilyVariant extends \Akeneo\Pim\Structure\Component\Model\FamilyVariant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'id', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'code', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'family', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'variantAttributeSets', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'locale', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'translations', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariant' . "\0" . 'events'];
        }
    ...
    public function updateAxesForLevel(int $level, array $axes): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'updateAxesForLevel', [$level, $axes]);

        parent::updateAxesForLevel($level, $axes);
    }
    ...
    public function updateAttributesForLevel(int $level, array $attributes): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'updateAttributesForLevel', [$level, $attributes]);

        parent::updateAttributesForLevel($level, $attributes);
    }
    ...
    public function addEvent(string $eventName): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEvent', [$eventName]);

        parent::addEvent($eventName);
    }
