...
class Family extends \Akeneo\Pim\Structure\Component\Model\Family implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function getTranslation(string $locale = NULL): ?\Akeneo\Pim\Structure\Component\Model\FamilyTranslationInterface
    {
    ...
    public function updateAttributes(array $attributes = []): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'updateAttributes', [$attributes]);
