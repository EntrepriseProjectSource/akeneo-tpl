 ...
 */
class AttributeGroup extends \Akeneo\Pim\Structure\Component\Model\AttributeGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'sortOrder', 'created', 'updated', 'attributes', 'locale', 'translations'];
        }
    ...
    public function getMaxAttributeSortOrder()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMaxAttributeSortOrder', []);
     ...
     * {@inheritDoc}
     */
    public function getTranslation(string $locale = NULL): ?\Akeneo\Pim\Structure\Component\Model\AttributeGroupTranslationInterface
    {
