 ...
 */
class GroupType extends \Akeneo\Pim\Structure\Component\Model\GroupType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'groups', 'locale', 'translations'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupType $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getTranslation(string $locale = NULL): ?\Akeneo\Pim\Structure\Component\Model\GroupTypeTranslationInterface
    {
