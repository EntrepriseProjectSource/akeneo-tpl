...
class Attribute extends \Akeneo\Pim\Structure\Component\Model\Attribute implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function addAvailableLocale(\Akeneo\Channel\Infrastructure\Component\Model\LocaleInterface $availableLocale)
    {
     ...
     * {@inheritDoc}
     */
    public function removeAvailableLocale(\Akeneo\Channel\Infrastructure\Component\Model\LocaleInterface $availableLocale)
    {
     ...
     * {@inheritDoc}
     */
    public function hasLocaleSpecific(\Akeneo\Channel\Infrastructure\Component\Model\LocaleInterface $locale)
    {
     ...
     * {@inheritDoc}
     */
    public function getTranslation(string $locale = NULL): ?\Akeneo\Pim\Structure\Component\Model\AttributeTranslationInterface
    {
    ...
    public function addGuidelines(string $locale, string $localeGuidelines): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGuidelines', [$locale, $localeGuidelines]);

        parent::addGuidelines($locale, $localeGuidelines);
    }
    ...
    public function removeGuidelines(string $locale): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeGuidelines', [$locale]);

        parent::removeGuidelines($locale);
    }
    ...
    public function getGuidelinesLocaleCodes(): array
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGuidelinesLocaleCodes', []);

        return parent::getGuidelinesLocaleCodes();
    }
    ...
    public function getRawTableConfiguration(): ?array
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRawTableConfiguration', []);

        return parent::getRawTableConfiguration();
    }
    ...
    public function setRawTableConfiguration(?array $rawTableConfiguration): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRawTableConfiguration', [$rawTableConfiguration]);

        parent::setRawTableConfiguration($rawTableConfiguration);
    }
