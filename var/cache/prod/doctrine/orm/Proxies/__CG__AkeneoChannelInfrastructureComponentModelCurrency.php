 ...
 */
class Currency extends \Akeneo\Channel\Infrastructure\Component\Model\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'activated'];
        }
    ...
    public function toggleActivation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'toggleActivation', []);
