...
class User extends \Akeneo\UserManagement\Component\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'email', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'image', 'avatar', 'imageFile', 'enabled', 'salt', 'password', 'plainPassword', 'confirmationToken', 'passwordRequestedAt', 'lastLogin', 'loginCount', 'roles', 'groups', 'api', 'createdAt', 'updatedAt', 'catalogLocale', 'uiLocale', 'catalogScope', 'defaultTree', 'defaultGridViews', 'emailNotifications', 'productGridFilters', 'phone', 'timezone', '' . "\0" . 'Akeneo\\UserManagement\\Component\\Model\\User' . "\0" . 'properties', '' . "\0" . 'Akeneo\\UserManagement\\Component\\Model\\User' . "\0" . 'consecutiveAuthenticationFailureCounter', '' . "\0" . 'Akeneo\\UserManagement\\Component\\Model\\User' . "\0" . 'authenticationFailureResetDate', 'type', '' . "\0" . 'Akeneo\\UserManagement\\Component\\Model\\User' . "\0" . 'profile'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCatalogLocale(\Akeneo\Channel\Infrastructure\Component\Model\LocaleInterface $catalogLocale)
    {
     ...
     * {@inheritDoc}
     */
    public function setUiLocale(\Akeneo\Channel\Infrastructure\Component\Model\LocaleInterface $uiLocale)
    {
     ...
     * {@inheritDoc}
     */
    public function setCatalogScope(\Akeneo\Channel\Infrastructure\Component\Model\ChannelInterface $catalogScope)
    {
     ...
     * {@inheritDoc}
     */
    public function setDefaultTree(\Akeneo\Category\Infrastructure\Component\Classification\Model\CategoryInterface $defaultTree)
    {
    ...
    public function isJobUser(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isJobUser', []);

        return parent::isJobUser();
    }
    ...
    public function defineAsJobUser(): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'defineAsJobUser', []);

        parent::defineAsJobUser();
    }
    ...
    public function getConsecutiveAuthenticationFailureCounter(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConsecutiveAuthenticationFailureCounter', []);

        return parent::getConsecutiveAuthenticationFailureCounter();
    }
    ...
    public function setConsecutiveAuthenticationFailureCounter(int $consecutiveAuthenticationFailureCounter): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setConsecutiveAuthenticationFailureCounter', [$consecutiveAuthenticationFailureCounter]);

        parent::setConsecutiveAuthenticationFailureCounter($consecutiveAuthenticationFailureCounter);
    }
    ...
    public function getAuthenticationFailureResetDate(): ?\DateTime
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthenticationFailureResetDate', []);

        return parent::getAuthenticationFailureResetDate();
    }
    ...
    public function setAuthenticationFailureResetDate(?\DateTime $authenticationFailureResetDate): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthenticationFailureResetDate', [$authenticationFailureResetDate]);

        parent::setAuthenticationFailureResetDate($authenticationFailureResetDate);
    }

    /**
     * {@inheritDoc}
     */
    public function duplicate(): \Akeneo\UserManagement\Component\Model\UserInterface
    {
