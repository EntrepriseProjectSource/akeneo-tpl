 ...
 */
class VariantAttributeSet extends \Akeneo\Pim\Structure\Component\Model\VariantAttributeSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\VariantAttributeSet' . "\0" . 'id', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\VariantAttributeSet' . "\0" . 'attributes', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\VariantAttributeSet' . "\0" . 'axes', '' . "\0" . 'Akeneo\\Pim\\Structure\\Component\\Model\\VariantAttributeSet' . "\0" . 'level'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VariantAttributeSet $proxy) {
     ...
     * {@inheritDoc}
     */
    public function hasAttribute(\Akeneo\Pim\Structure\Component\Model\AttributeInterface $attribute): bool
    {
     ...
     * {@inheritDoc}
     */
    public function addAttribute(\Akeneo\Pim\Structure\Component\Model\AttributeInterface $attribute): void
    {
    ...
    public function getAxesLabels(string $localeCode): array
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAxesLabels', [$localeCode]);

        return parent::getAxesLabels($localeCode);
    }
