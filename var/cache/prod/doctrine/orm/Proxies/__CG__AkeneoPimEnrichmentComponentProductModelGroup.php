 ...
 */
class Group extends \Akeneo\Pim\Enrichment\Component\Product\Model\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'code', 'type', 'products', 'locale', 'translations'];
        }
     ...
     * {@inheritDoc}
     */
    public function setType(\Akeneo\Pim\Structure\Component\Model\GroupTypeInterface $type)
    {
     ...
     * {@inheritDoc}
     */
    public function getTranslation(string $locale = NULL): ?\Akeneo\Pim\Enrichment\Component\Product\Model\GroupTranslationInterface
    {
