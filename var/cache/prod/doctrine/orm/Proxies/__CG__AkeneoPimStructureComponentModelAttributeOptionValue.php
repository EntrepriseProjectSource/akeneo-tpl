 ...
 */
class AttributeOptionValue extends \Akeneo\Pim\Structure\Component\Model\AttributeOptionValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'option', 'locale', 'value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttributeOptionValue $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOption(\Akeneo\Pim\Structure\Component\Model\AttributeOptionInterface $option)
    {
