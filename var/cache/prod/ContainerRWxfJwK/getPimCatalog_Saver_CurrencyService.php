 ...
 */
class getPimCatalog_Saver_CurrencyService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_catalog.saver.currency' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pim_catalog.saver.currency'])) {
            return $container->privates['pim_catalog.saver.currency'];
        }
        ...
        return $container->privates['pim_catalog.saver.currency'] = new \Akeneo\Tool\Bundle\StorageUtilsBundle\Doctrine\Common\Saver\BaseSaver($a, $b, 'Akeneo\\Channel\\Infrastructure\\Component\\Model\\CurrencyInterface');
    }
}
