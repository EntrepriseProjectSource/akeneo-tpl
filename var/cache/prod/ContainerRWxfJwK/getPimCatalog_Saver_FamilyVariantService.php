 ...
 */
class getPimCatalog_Saver_FamilyVariantService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_catalog.saver.family_variant' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pim_catalog.saver.family_variant'])) {
            return $container->privates['pim_catalog.saver.family_variant'];
        }
        ...
        return $container->privates['pim_catalog.saver.family_variant'] = new \Akeneo\Tool\Bundle\StorageUtilsBundle\Doctrine\Common\Saver\BaseSaver($a, $b, 'Akeneo\\Pim\\Structure\\Component\\Model\\FamilyVariantInterface');
    }
}
