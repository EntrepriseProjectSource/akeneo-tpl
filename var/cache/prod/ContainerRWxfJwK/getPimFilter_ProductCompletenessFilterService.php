 ...
 */
class getPimFilter_ProductCompletenessFilterService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_filter.product_completeness_filter' shared service.
     *
     * @return \Oro\Bundle\PimFilterBundle\Filter\Product\ProductCompletenessFilter
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/akeneo/pim-community-dev/src/Oro/Bundle/PimFilterBundle/Filter/Product/ProductCompletenessFilter.php';
        ...
        if (isset($container->privates['pim_filter.product_completeness_filter'])) {
            return $container->privates['pim_filter.product_completeness_filter'];
        }

        return $container->privates['pim_filter.product_completeness_filter'] = new \Oro\Bundle\PimFilterBundle\Filter\Product\ProductCompletenessFilter($a, ($container->privates['pim_filter.product_utility'] ?? ($container->privates['pim_filter.product_utility'] = new \Oro\Bundle\PimFilterBundle\Filter\ProductFilterUtility())));
    }
}
