 ...
 */
class getOneupFlysystem_JobsStorageFilesystemService extends KernelProdContainer
{
    /*
     * Gets the public 'oneup_flysystem.jobs_storage_filesystem' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['oneup_flysystem.jobs_storage_filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Local\LocalFilesystemAdapter((\dirname(__DIR__, 3).'/file_storage/jobs'), NULL, 2, 2, NULL), []);
    }
}
