 ...
 */
class getCacheWarmerService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['doctrine.orm.proxy_cache_warmer'] ?? $container->load('getDoctrine_Orm_ProxyCacheWarmerService'));
            ...
            yield 8 => ($container->privates['oro_security.acl.annotation_provider.cache.warmer'] ?? $container->load('getOroSecurity_Acl_AnnotationProvider_Cache_WarmerService'));
            yield 9 => ($container->privates['oro_security.action_metadata_provider.cache.warmer'] ?? $container->load('getOroSecurity_ActionMetadataProvider_Cache_WarmerService'));
        }, 10), false, ($container->targetDir.''.'/KernelProdContainerDeprecations.log'));
    }
}
