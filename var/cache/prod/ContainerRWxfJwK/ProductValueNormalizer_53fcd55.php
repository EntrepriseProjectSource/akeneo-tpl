...
class ProductValueNormalizer_53fcd55 extends \Akeneo\Pim\Enrichment\Component\Product\Normalizer\Standard\Product\ProductValueNormalizer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerf6b70 && ($this->initializerf6b70->__invoke($valueHolder8d85c, $this, 'normalize', array('entity' => $entity, 'format' => $format, 'context' => $context), $this->initializerf6b70) || 1) && $this->valueHolder8d85c = $valueHolder8d85c;
        return $this->valueHolder8d85c->normalize($entity, $format, $context);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Akeneo\Pim\Enrichment\Component\Product\Normalizer\Standard\Product\ProductValueNormalizer $instance) {
            unset($instance->normalizer, $instance->getAttributes);
    ...
    public function __construct(\Symfony\Component\Serializer\Normalizer\NormalizerInterface $normalizer, \Akeneo\Pim\Structure\Component\Query\PublicApi\AttributeType\GetAttributes $getAttributes)
    {
        static $reflection;
        ...
        $this->valueHolder8d85c->__construct($normalizer, $getAttributes);
    }
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Standard\\Product\\ProductValueNormalizer');
...
if (!\class_exists('ProductValueNormalizer_53fcd55', false)) {
    \class_alias(__NAMESPACE__.'\\ProductValueNormalizer_53fcd55', 'ProductValueNormalizer_53fcd55', false);
}
