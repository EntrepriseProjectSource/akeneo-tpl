 ...
 */
class getFosJsRouting_ExtractorService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor(($container->services['router'] ?? $container->getRouterService()), [0 => '.*'], $container->targetDir.'', $container->parameters['kernel.bundles']);
    }
}
