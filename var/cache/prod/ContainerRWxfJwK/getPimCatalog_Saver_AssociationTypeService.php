 ...
 */
class getPimCatalog_Saver_AssociationTypeService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_catalog.saver.association_type' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pim_catalog.saver.association_type'])) {
            return $container->privates['pim_catalog.saver.association_type'];
        }
        ...
        return $container->privates['pim_catalog.saver.association_type'] = new \Akeneo\Tool\Bundle\StorageUtilsBundle\Doctrine\Common\Saver\BaseSaver($a, $b, 'Akeneo\\Pim\\Structure\\Component\\Model\\AssociationTypeInterface');
    }
}
