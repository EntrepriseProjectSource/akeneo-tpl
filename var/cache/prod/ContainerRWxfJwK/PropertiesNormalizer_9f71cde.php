...
class PropertiesNormalizer_9f71cde extends \Akeneo\Pim\Enrichment\Component\Product\Normalizer\Standard\Product\PropertiesNormalizer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    public function __construct(\Akeneo\Pim\Enrichment\Bundle\Filter\CollectionFilterInterface $filter, \Symfony\Component\Serializer\Normalizer\NormalizerInterface $normalizer)
    {
        ...
        $this->valueHolder8d85c->__construct($filter, $normalizer);
    }
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Standard\\Product\\PropertiesNormalizer');
...
if (!\class_exists('PropertiesNormalizer_9f71cde', false)) {
    \class_alias(__NAMESPACE__.'\\PropertiesNormalizer_9f71cde', 'PropertiesNormalizer_9f71cde', false);
}
