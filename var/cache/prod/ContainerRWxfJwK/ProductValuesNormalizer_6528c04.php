...
class ProductValuesNormalizer_6528c04 extends \Akeneo\Pim\Enrichment\Component\Product\Normalizer\Standard\Product\ProductValuesNormalizer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializerf6b70 && ($this->initializerf6b70->__invoke($valueHolder8d85c, $this, 'normalize', array('data' => $data, 'format' => $format, 'context' => $context), $this->initializerf6b70) || 1) && $this->valueHolder8d85c = $valueHolder8d85c;
        return $this->valueHolder8d85c->normalize($data, $format, $context);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Akeneo\Pim\Enrichment\Component\Product\Normalizer\Standard\Product\ProductValuesNormalizer $instance) {
            unset($instance->normalizer);
        }, $instance, 'Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Standard\\Product\\ProductValuesNormalizer')->__invoke($instance);
    ...
    public function __construct(\Symfony\Component\Serializer\Normalizer\NormalizerInterface $normalizer)
    {
        ...
        if (! $this->valueHolder8d85c) {
            $reflection = $reflection ?? new \ReflectionClass('Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Standard\\Product\\ProductValuesNormalizer');
            $this->valueHolder8d85c = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Akeneo\Pim\Enrichment\Component\Product\Normalizer\Standard\Product\ProductValuesNormalizer $instance) {
            unset($instance->normalizer);
        }, $this, 'Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Standard\\Product\\ProductValuesNormalizer')->__invoke($this);
        }
        $this->valueHolder8d85c->__construct($normalizer);
    }
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Standard\\Product\\ProductValuesNormalizer');
...
if (!\class_exists('ProductValuesNormalizer_6528c04', false)) {
    \class_alias(__NAMESPACE__.'\\ProductValuesNormalizer_6528c04', 'ProductValuesNormalizer_6528c04', false);
}
