 ...
 */
class getOroFilter_NumberFilterService extends KernelProdContainer
{
    /*
     * Gets the private 'oro_filter.number_filter' shared service.
     *
     * @return \Oro\Bundle\FilterBundle\Filter\NumberFilter
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['oro_filter.number_filter'])) {
            return $container->privates['oro_filter.number_filter'];
        }

        return $container->privates['oro_filter.number_filter'] = new \Oro\Bundle\FilterBundle\Filter\NumberFilter($a, ($container->privates['oro_filter.filter_utility'] ?? ($container->privates['oro_filter.filter_utility'] = new \Oro\Bundle\FilterBundle\Filter\FilterUtility())));
    }
}
