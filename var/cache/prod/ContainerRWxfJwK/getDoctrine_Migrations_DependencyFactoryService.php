 ...
 */
class getDoctrine_Migrations_DependencyFactoryService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->setVersionColumnLength(190);
        $b->setExecutedAtColumnName('executed_at');

        $a->addMigrationsDirectory('Pim\\Upgrade\\Schema', (\dirname(__DIR__, 4).'/upgrades/schema'));
