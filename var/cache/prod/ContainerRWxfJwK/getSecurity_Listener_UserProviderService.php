 ...
 */
class getSecurity_Listener_UserProviderService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.user_provider'] = new \Symfony\Component\Security\Http\EventListener\UserProviderListener(new \Symfony\Component\Security\Core\User\ChainUserProvider(new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['pim_user.provider.user'] ?? $container->load('getPimUser_Provider_UserService'));
            yield 2 => ($container->privates['pim_user.provider.user_api'] ?? $container->load('getPimUser_Provider_UserApiService'));
        }, 3)));
    }
}
