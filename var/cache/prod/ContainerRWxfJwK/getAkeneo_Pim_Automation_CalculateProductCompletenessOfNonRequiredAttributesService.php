 ...
 */
class getAkeneo_Pim_Automation_CalculateProductCompletenessOfNonRequiredAttributesService extends KernelProdContainer
{
    /*
     * Gets the private 'akeneo.pim.automation.calculate_product_completeness_of_non_required_attributes' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/akeneo/pim-community-dev/src/Akeneo/Pim/Automation/DataQualityInsights/back/Infrastructure/Persistence/Query/Completeness/GetNonRequiredAttributesMasksQuery.php';
        ...
        if (isset($container->privates['akeneo.pim.automation.calculate_product_completeness_of_non_required_attributes'])) {
            return $container->privates['akeneo.pim.automation.calculate_product_completeness_of_non_required_attributes'];
        }
        ...
        return $container->privates['akeneo.pim.automation.calculate_product_completeness_of_non_required_attributes'] = new \Akeneo\Pim\Automation\DataQualityInsights\Infrastructure\Enrichment\CalculateProductCompleteness(new \Akeneo\Pim\Enrichment\Component\Product\Completeness\CompletenessCalculator($a, new \Akeneo\Pim\Automation\DataQualityInsights\Infrastructure\Persistence\Query\Completeness\GetNonRequiredAttributesMasksQuery($b, ($container->privates['Akeneo\\Pim\\Automation\\DataQualityInsights\\Infrastructure\\Persistence\\Query\\BuildSqlMaskField'] ?? $container->load('getBuildSqlMaskFieldService')))));
    }
}
