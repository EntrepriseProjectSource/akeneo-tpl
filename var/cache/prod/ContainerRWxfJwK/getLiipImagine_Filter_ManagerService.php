 ...
 */
class getLiipImagine_Filter_ManagerService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/akeneo/pim-community-dev/src/Akeneo/Platform/Bundle/UIBundle/Imagine/IccStripFilter.php';
        include_once \dirname(__DIR__, 4).'/vendor/akeneo/pim-community-dev/src/Akeneo/Platform/Bundle/UIBundle/Imagine/FlattenLayersFilter.php';
        ...
        $instance->addLoader('icc_strip', new \Akeneo\Platform\Bundle\UIBundle\Imagine\IccStripFilter());
        $instance->addLoader('flatten_layers', new \Akeneo\Platform\Bundle\UIBundle\Imagine\FlattenLayersFilter());
