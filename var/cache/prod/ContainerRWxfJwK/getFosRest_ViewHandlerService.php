 ...
 */
class getFosRest_ViewHandlerService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['fos_rest.view_handler'] = \FOS\RestBundle\View\ViewHandler::create(($container->services['router'] ?? $container->getRouterService()), ($container->privates['fos_rest.serializer'] ?? $container->load('getFosRest_SerializerService')), ($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ['json' => false], 400, 204, false, ['serializeNullStrategy' => false]);
    }
}
