 ...
 */
class getLiipImagine_Cache_ManagerService extends KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addResolver('category_flysystem_cache', ($container->services['liip_imagine.cache.resolver.category_flysystem_cache'] ?? $container->load('getLiipImagine_Cache_Resolver_CategoryFlysystemCacheService')));
