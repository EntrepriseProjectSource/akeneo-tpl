...
class ValueCollectionNormalizer_725de7c extends \Akeneo\Pim\Enrichment\Component\Product\Normalizer\Indexing\Value\ValueCollectionNormalizer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Akeneo\Pim\Enrichment\Component\Product\Normalizer\Indexing\Value\ValueCollectionNormalizer $instance) {
            unset($instance->normalizer);
        }, $instance, 'Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Indexing\\Value\\ValueCollectionNormalizer')->__invoke($instance);
    ...
    public function __construct(\Symfony\Component\Serializer\Normalizer\NormalizerInterface $normalizer)
    {
        ...
        if (! $this->valueHolder8d85c) {
            $reflection = $reflection ?? new \ReflectionClass('Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Indexing\\Value\\ValueCollectionNormalizer');
            $this->valueHolder8d85c = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Akeneo\Pim\Enrichment\Component\Product\Normalizer\Indexing\Value\ValueCollectionNormalizer $instance) {
            unset($instance->normalizer);
        }, $this, 'Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Indexing\\Value\\ValueCollectionNormalizer')->__invoke($this);
        }
    ...
    public function & __get($name)
    {
        ...
        $realInstanceReflection = new \ReflectionClass('Akeneo\\Pim\\Enrichment\\Component\\Product\\Normalizer\\Indexing\\Value\\ValueCollectionNormalizer');
...
if (!\class_exists('ValueCollectionNormalizer_725de7c', false)) {
    \class_alias(__NAMESPACE__.'\\ValueCollectionNormalizer_725de7c', 'ValueCollectionNormalizer_725de7c', false);
}
