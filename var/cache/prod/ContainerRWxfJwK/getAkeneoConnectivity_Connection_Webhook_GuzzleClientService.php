 ...
 */
class getAkeneoConnectivity_Connection_Webhook_GuzzleClientService extends KernelProdContainer
{
    /*
     * Gets the private 'akeneo_connectivity.connection.webhook.guzzle_client' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['akeneo_connectivity.connection.webhook.guzzle_client'] = new \GuzzleHttp\Client(['handler' => \GuzzleHttp\HandlerStack::create(), 'headers' => ['User-Agent' => NULL]]);
    }
}
