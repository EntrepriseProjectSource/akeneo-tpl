 ...
 */
class getPimUser_Saver_RoleService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_user.saver.role' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pim_user.saver.role'])) {
            return $container->privates['pim_user.saver.role'];
        }
        ...
        return $container->privates['pim_user.saver.role'] = new \Akeneo\Tool\Bundle\StorageUtilsBundle\Doctrine\Common\Saver\BaseSaver($a, $b, 'Akeneo\\UserManagement\\Component\\Model\\Role');
    }
}
