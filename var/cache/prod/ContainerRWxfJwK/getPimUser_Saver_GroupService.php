 ...
 */
class getPimUser_Saver_GroupService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_user.saver.group' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pim_user.saver.group'])) {
            return $container->privates['pim_user.saver.group'];
        }
        ...
        return $container->privates['pim_user.saver.group'] = new \Akeneo\Tool\Bundle\StorageUtilsBundle\Doctrine\Common\Saver\BaseSaver($a, $b, 'Akeneo\\UserManagement\\Component\\Model\\Group');
    }
}
