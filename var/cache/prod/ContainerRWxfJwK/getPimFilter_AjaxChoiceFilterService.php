 ...
 */
class getPimFilter_AjaxChoiceFilterService extends KernelProdContainer
{
    /*
     * Gets the private 'pim_filter.ajax_choice_filter' shared service.
     *
     * @return \Oro\Bundle\PimFilterBundle\Filter\AjaxChoiceFilter
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['pim_filter.ajax_choice_filter'])) {
            return $container->privates['pim_filter.ajax_choice_filter'];
        }

        return $container->privates['pim_filter.ajax_choice_filter'] = new \Oro\Bundle\PimFilterBundle\Filter\AjaxChoiceFilter($a, ($container->privates['pim_filter.product_utility'] ?? ($container->privates['pim_filter.product_utility'] = new \Oro\Bundle\PimFilterBundle\Filter\ProductFilterUtility())));
    }
}
