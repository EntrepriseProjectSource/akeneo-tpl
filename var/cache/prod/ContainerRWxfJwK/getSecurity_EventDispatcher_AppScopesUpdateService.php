 ...
 */
class getSecurity_EventDispatcher_AppScopesUpdateService extends KernelProdContainer
{
    /*
     * Gets the private 'security.event_dispatcher.app_scopes_update' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.app_scopes_update'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.app_scopes_update.user_provider'] ?? $container->load('getSecurity_Listener_AppScopesUpdate_UserProviderService'));
        }, 1 => 'checkPassport'], 2048);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.app_scopes_update'] ?? $container->load('getSecurity_Listener_UserChecker_AppScopesUpdateService'));
        ...
        $instance->addListener('security.interactive_login', [0 => function () use ($container) {
            return ($container->privates['pim_user.security.login'] ?? $container->load('getPimUser_Security_LoginService'));
        }, 1 => 'onLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
        ...
        $instance->addListener('security.interactive_login', [0 => function () use ($container) {
            return ($container->privates['pim_locale.locale_subscriber'] ?? $container->getPimLocale_LocaleSubscriberService());
