 ...
 */
class getAkeneoFileStorage_Saver_FileService extends KernelProdContainer
{
    /*
     * Gets the private 'akeneo_file_storage.saver.file' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['akeneo_file_storage.saver.file'])) {
            return $container->privates['akeneo_file_storage.saver.file'];
        }
        ...
        return $container->privates['akeneo_file_storage.saver.file'] = new \Akeneo\Tool\Bundle\StorageUtilsBundle\Doctrine\Common\Saver\BaseSaver($a, $b, 'Akeneo\\Tool\\Component\\FileStorage\\Model\\FileInfoInterface');
    }
}
